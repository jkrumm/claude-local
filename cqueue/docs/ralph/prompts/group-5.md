...
1. Read `cqueue/src/pages/RepoDashboard.tsx` from Group 4 — understand where QueuePanel plugs in
2. Read `cqueue/docs/ralph/RALPH_NOTES.md` for any Group 4 deviations
...
```
feat(cqueue): add queue panel with drag-and-drop, add/delete/edit task cards
```
