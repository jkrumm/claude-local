...
concurrency, data-migration, api-contract, resilience — when the diff warrants them. Use
this by default; read the `backend` field on the result rather than assuming
where it ran.
